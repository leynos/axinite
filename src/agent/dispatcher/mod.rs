...
//! - `preflight`: Tool call preflight checks and batching
//! - `execution`: Tool execution (inline and parallel)
//! - `postflight`: Post-execution processing and context folding
...
struct ToolBatch {
    ...
    runnable: Vec<(usize, crate::llm::ToolCall)>,
}
