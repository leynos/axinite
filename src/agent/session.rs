...
type MessageIter = std::iter::Peekable<std::vec::IntoIter<ChatMessage>>;
...
fn consume_tool_call_rounds(iter: &mut MessageIter, turn: &mut Turn) {
...
fn consume_final_response(iter: &mut MessageIter, turn: &mut Turn) {
