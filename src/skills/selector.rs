...
mod tests {
    ...
    fn test_empty_message_returns_nothing() {
        let skills =
            vec![make_skill("test", &["write"], &[], &[]).expect("test skill should build")];
    ...
    fn test_keyword_exact_match() {
        let skills = vec![
            make_skill("writing", &["write", "edit"], &[], &[]).expect("test skill should build"),
        ];
        let result = prefilter_skills(
    ...
    fn test_context_budget_limit() {
        ...
        let mut skill2 =
            make_skill("also_big", &["test"], &[], &[]).expect("test skill should build");
    ...
    fn test_invalid_regex_handled_gracefully() {
        let skills = vec![
            make_skill("bad", &["test"], &[], &["[invalid regex"])
                .expect("test skill should build"),
        ];
    ...
    fn test_keyword_score_capped() {
        ...
        let skill =
            make_skill("spammer", &many_keywords, &[], &[]).expect("test skill should build");
    ...
    fn test_tag_score_capped() {
        ...
        let skill =
            make_skill("tag-spammer", &[], &many_tags, &[]).expect("test skill should build");
        let skills = vec![skill];
        let result = prefilter_skills(
            "alpha bravo charlie delta echo foxtrot golf hotel",
            &skills,
    ...
    fn test_zero_context_tokens_still_costs_budget() {
        ...
        let mut skill2 =
            make_skill("also_free", &["test"], &[], &[]).expect("test skill should build");
