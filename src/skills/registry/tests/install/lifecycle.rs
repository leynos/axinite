//! Install lifecycle tests: duplicate rejection, staged-directory cleanup,
//! and bundle removal followed by reinstall.
...
use super::assert_deploy_docs_bundle_files_present;
