...
//!
//! When Axinite is distributed as a pre-built binary without a source tree,
...
const EMBEDDED_CATALOG: &str = include_str!(concat!(env!("OUT_DIR"), "/embedded_catalogue.json"));
