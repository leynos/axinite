//! Assembly internals for [`TestRigBuilder`]: LLM and interceptor
//! resolution, optional subsystem registration, database/config setup,
//! component and agent wiring, and the public `build` entry point.
