...
) -> Result<(LlmTrace, crate::support::test_rig::TestRig)> {
...
#[tokio::test]
async fn test_injection_patterns_sanitized() -> Result<()> {
...
#[tokio::test]
async fn test_injection_patterns_pass_without_check() -> Result<()> {
