...
tool-install contracts read one parsed view of ``.github/workflows``. What an
event admits and expands to is in `_trigger_reading.py`, and what a cache step
touches is in `_cache_policy.py`.
