...
This document is a stub for the HTTP API exposed by the web gateway. The
in-code route table in `src/channels/web/CLAUDE.md` remains the authoritative
index until this document is completed in a future PR.
...
The full route table (jobs, memory, routines, settings, skills, extensions, and
static assets) will be added in a future PR. For now, see
